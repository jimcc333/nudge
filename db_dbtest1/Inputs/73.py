...
################################
# all in [cm]
fuel_cell_radius = 0.453602
void_cell_radius = 0.462102
clad_cell_radius = 0.5239
unit_cell_pitch  = 0.65635 * 2.0
unit_cell_height = 10.0

fuel_density = 11.1601
clad_density = 5.41303
cool_density = 0.696311
